...
export default function Rayon() {
  ...
  return (
    <Layout>
      ...
      {/* Le chef est en poste : plus d'abonnement ni de location (07/09/2026).
          Chaque question, chaque conseil et chaque passage AUTO-MODE se paient
          en drops, au moment où ils ont lieu. */}
      <div className="mt-4 flex flex-wrap items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3">
        <p className="text-xs text-gray-300">
          {`${department.agentName} est en poste. Ses questions et son mode automatique se paient en drops — voir `}
          <Link to="/credits" className="text-purple-300 hover:underline">
            Mes crédits
          </Link>
          .
        </p>
        ...
        {/* L'interrupteur AUTO-MODE : analyse de marché + dix gagnants toutes
            les douze heures. Chaque passage coûte des drops (facturés par la
            tournée), activer l'interrupteur est libre. */}
        <BoutonAutoMode
