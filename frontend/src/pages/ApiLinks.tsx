  ...
  return (
    <Layout>
      <h1 className="flex items-center gap-2 text-2xl font-bold">
        ...
        <span>Mes clés et raccordements</span>
      </h1>
      <p className="mt-1 max-w-3xl text-sm text-gray-400">
        Tout ce qui relie DropShipper à l'extérieur : les places de marché où vous publiez, les
        régies où vous faites de la publicité, et les clés que vos propres outils utilisent pour
        déposer dans votre catalogue.
      </p>
