      ...
      <div className="mt-5 flex flex-wrap items-center gap-2 rounded-xl border border-white/10 bg-white/5 p-3">
        ...
        <div className="ml-auto flex flex-wrap gap-2">
          <button
            ...
            className="btn-gradient inline-flex items-center gap-1 rounded-lg px-3 py-2.5 text-xs sm:py-1.5 font-semibold disabled:opacity-40"
          >
            <Download size={13} />
            <span>
              {running
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-white/10 px-3 py-2.5 text-xs sm:py-1.5 text-gray-400 hover:bg-white/5 hover:text-red-400 disabled:opacity-40"
          >
            <Trash2 size={13} />
            <span>Supprimer</span>
          </button>
