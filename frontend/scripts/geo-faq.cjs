...
module.exports = ({ nbCanaux, nbFournisseurs }) => [
  ...
  },
  {
    ...
    a: `${nbCanaux} canaux de vente sont référencés, et chacun a sa voie de liaison. Publication directe : Shopify, WooCommerce, PrestaShop, Magento, Drupal Commerce, BigCommerce, Wix, Shopware, Ecwid, Squarespace, eBay, Kaufland, la boutique du vendeur et 41 places de marché françaises et européennes sous Mirakl (E.Leclerc, Carrefour, Fnac Darty…), plus Amazon, Cdiscount, TikTok Shop, Etsy, Spartoo et Miinto dès que le vendeur colle son compte. Flux produit collé une fois : comparateurs, affiliation, régies et la plupart des autres places de marché. Vinted, Leboncoin et Facebook Marketplace passent par l'extension Chrome, qui remplit le formulaire ; le vendeur valide.`,
  },
  {
