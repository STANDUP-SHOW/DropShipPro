...
const FONCTIONS = [
  ...
  },
  {
    ...
    lignes: [
      'Publication réelle et immédiate vers : la boutique du vendeur, Shopify, eBay, Kaufland et 41 opérateurs Mirakl (E.Leclerc, Carrefour, Auchan, Fnac, La Redoute, Boulanger, Leroy Merlin, Galeries Lafayette, Cultura, Truffaut, El Corte Inglés, MediaMarkt, Worten…).',
  ...
  },
  {
    ...
    lignes: [
      'Création d’une boutique complète en quelques clics : 50 thèmes, panier, prise de commande, adresse publique.',
...
Votre propre boutique, Shopify, eBay, Kaufland, et les 41 opérateurs Mirakl :
